...
setwd("C:/Users/samue/Committee of 100, Inc/Research - Reports/Alien land laws/landlaw_app")
...
save(d_bills_states_sf, file = "d_bills_states_sf.rdata")
